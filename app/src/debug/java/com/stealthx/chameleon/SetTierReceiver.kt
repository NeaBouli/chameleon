 ...
 *
 * ADB usage:
 *   adb shell am broadcast -a com.stealthx.chameleon.SET_TIER \
 *     --es tier ELITE -n com.stealthx.chameleon.debug/.SetTierReceiver
 */
@AndroidEntryPoint
class SetTierReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action != "com.stealthx.chameleon.SET_TIER") return
