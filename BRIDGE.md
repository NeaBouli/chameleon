...
- The Kotlin verifier accepts a canonical token generated by the actual Node entitlement signer and still enforces Chameleon audience, product, device, tier, expiry and signature binding.
- Operational values remain private. Production sales stay disabled; no payment, activation, provider request or deployment was performed.
