 ...
 * 3. The wallet signs the challenge and redirects to chameleon://wc
...
class WalletConnectManager @Inject constructor(
    ...
    fun createWalletOpenIntent(): Intent {
        ...
        val message = "Chameleon wants you to verify your Ethereum wallet.\n\n" +
        ...
        val pageUrl = Uri.Builder()
            ...
            .path("siwe.html")
            .appendQueryParameter("deviceId", "chameleon")
        ...
        val uri = when (preferredPackage) {
            METAMASK_PACKAGE -> "metamask://dapp/stealthx.tech/siwe.html?deviceId=chameleon&message=${Uri.encode(message)}&returnScheme=chameleon&returnHost=wc"
    ...
    fun handleDeepLink(uri: Uri?): Boolean {
        if (uri?.scheme != "chameleon" || uri.host != "wc") return false
