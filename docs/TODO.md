...
- [ ] Play Integrity API fuer Chameleon planen: zunaechst nur als Risk-Signal/Logging fuer Lizenz-, App-, Geraete-, Play-Protect- und App-Access-Risiko; keine harte Sperre am App-Start. Harte Checks erst spaeter fuer kritische Aktionen wie Kauf/Upgrade/Activation-Code-Redeem entscheiden.
