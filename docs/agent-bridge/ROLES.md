...
- Gio hat Codex als alleinigen Main Developer fuer das oeffentliche Chameleon-Repository eingesetzt.
- Codex uebernimmt Produktcode, Android, Privacy-/Overlay-/Decoy-Funktionen, Kryptografie-Integration, IFR, Tests, Releases-Vorbereitung sowie Stripe, Entitlements, Refunds und Etimologio/myDATA.
...
- Server-signiertes Chameleon-Entitlement, idempotente Auslieferung, Refund/Revoke und Payment-E2E-Tests.
