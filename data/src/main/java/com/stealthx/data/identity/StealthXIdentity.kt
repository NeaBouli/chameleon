...
object StealthXIdentity {
     ...
     * public key. Keypair and ID are written atomically.
     *
     * EXISTING INSTALLS: if KEY_RAW_ID already exists it is returned unchanged
     * (backward-compatible migration path — Option B).
     */
    ...
    private fun buildSignPayload(
        ...
        append(x25519.joinToString("") { b -> "%02x".format(b.toInt() and 0xFF) }); append("|")
        append(ed25519.joinToString("") { b -> "%02x".format(b.toInt() and 0xFF) }); append("|")
